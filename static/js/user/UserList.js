    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (let i = 0; i < response.length; i++) {
                ...
                fila += '<td><a href="/user/usuarios/edit/' + response[i]["pk"] + '" class="btn btn-primary"  >Editar </a> <a href="/user/usuarios/desactivar/' + response[i]["pk"] + '" class="btn btn-danger"  >Eliminar </a></td>';
                fila += '</tr>';
